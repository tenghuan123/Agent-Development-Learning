  ...
  const CONTEXT_LESSONS = [
    ...
    },
    {
      ...
      highlights: [
        ...
        "消除单一检索盲区：6 场景靶向召回率从 50% 跃迁至 100%",
      ],
      docPath: "docs/lessons/context/06-hybrid-retrieval-and-rrf.md",
    },
    {
      version: "C7",
      number: "第 07 课",
      ...
      docPath: "docs/lessons/context/07-reranking-and-cross-encoder.md",
    },
    {
      version: "C8",
      number: "第 08 课",
      title: "整篇文档太大，切碎了又讲不完整 (Chunking)",
      desc: "检索一直以「整篇文档」为原子单位。当文档长到 5,688 token，注入模型的信噪比跌到 0.46%。把原子单位下沉到 Chunk，并推导出：检索的粒度与注入的粒度不必相同。",
      ...
      badge: "切片治理",
      highlights: [
        "定长 / 结构感知 / 语义边界三种切分策略实测对决",
        "Overlap 重叠窗口：把净破坏从 16 降到 0，代价是索引冗余",
        "Small-to-Big 父子块：检索粒度 ≠ 注入粒度，注入量降 90%",
      ],
      docPath: "docs/lessons/context/08-chunking-granularity-and-boundaries.md",
    },
    {
      version: "C9",
      number: "第 09 课",
      title: "Chunk 自己可能没有意义怎么办？(Contextual Retrieval)",
      desc: "切碎的 Chunk 孤零零写着'这种情况下须触发熔断'，离开父文档便失去主语。研究 Parent-Child、Metadata 注入与上下文感知重构。",
      path: "#",
      icon: FolderTree,
