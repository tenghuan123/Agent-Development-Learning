...
| **V8** | [第 09 课](./lessons/09-mcp-standard-and-plugin-architecture.md) | **MCP (Model Context Protocol) 标准协议** | 🚀 本课落地 | MCP Client/Server 解耦、JSON-RPC 2.0 帧级抓包、手写 Mini Code Server |
